...
import StartupsData from "../data/StartupsData.json"; // Adjust the path as needed

const StartupsPage = () => {
  const backgroundImageUrl =
    "https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"; // Replace with your actual image URL
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-screen-lg p-4">
        {StartupsData.startups.map((article) => (
          <article
            key={article.id}
