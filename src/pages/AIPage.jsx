...
import AIData from "../data/AIData.json"; // Adjust the path as needed

const AIPage = () => {
  const backgroundImageUrl =
    "https://images.pexels.com/photos/249798/pexels-photo-249798.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"; // Replace with your actual image URL
    ...
    <div>
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-80 flex flex-col items-center justify-center space-y-4">
          <h1 className="text-8xl md:text-9xl font-protest-riot   ">A.I</h1>
          <p className="text-3xl  text-center">
            Shaping tomorrow with the intelligence of today
          </p>
        </div>
      </div>
      {/* Articles section */}
      <div className="mx-auto max-w-screen-lg p-4">
        {AIData.ai.map((article) => (
          <article
            key={article.id}
