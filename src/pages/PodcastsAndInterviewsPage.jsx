...
import PodcastsAndInterviewsData from "../data/PodcastsAndInterviewsData.json"; // Adjust the path as needed

const PodcastsAndInterviewsPage = () => {
  const backgroundImageUrl =
    "https://images.pexels.com/photos/1054713/pexels-photo-1054713.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"; // Replace with your actual image URL
  return (
    <div>
      {/* Hero image section */}
      <div
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-80 flex flex-col items-center justify-center space-y-4">
          <h1 className="text-8xl  md:text-9xl font-protest-riot   ">
            {" "}
            World of PodcastsAnd Interviews
          </h1>
      ...
      <div className="mx-auto max-w-screen-lg p-4">
        {PodcastsAndInterviewsData.podcastsandinterviews.map((article) => (
          <article
            key={article.id}
...
export default PodcastsAndInterviewsPage;
